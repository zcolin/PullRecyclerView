...
/**
 * 默认的下拉更多HeaderView，如需要简单的变换，可以直接在{@link com.zcolin.gui.zrecyclerview.ZRecyclerView}中设置
...
public class DefRefreshHeader extends LinearLayout implements IRefreshHeader {
    ...
    private void initView() {
        ...
        mContainer = (LinearLayout) LayoutInflater.from(getContext())
                                                  .inflate(R.layout.gui_zrecyclerview_header, null);
    ...
    public void onComplete() {
        ...
        SharedPreferences pre = getContext().getApplicationContext()
                                            .getSharedPreferences("zrecyclerview", Context.MODE_PRIVATE);
